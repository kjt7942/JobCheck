            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full px-5 py-3 bg-gray-50 border-2 rounded-2xl outline-none transition-all ${
                    error ? "border-red-200 focus:border-red-400 shake" : "border-gray-100 focus:border-green-500"
                  }`}
                  required
                />
              </div>
