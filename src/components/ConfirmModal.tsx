        ...
        <div className="p-8">
            <div className="flex flex-col items-center text-center">
                ...
                <div className="flex gap-3 w-full">
                    <button
                        onClick={onCancel}
                        className="flex-1 px-6 py-4 rounded-2xl text-sm font-bold text-gray-400 bg-[var(--input-bg)] hover:bg-[var(--card-bg)] border border-[var(--card-border)] transition-all duration-200"
                    >
                        {cancelText}
                    </button>
                    <button
